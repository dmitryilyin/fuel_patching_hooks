...
###################################################################
  ...
  context 'On Debian system' do
    ...
    it 'should find services to stop' do
      @class.services_to_stop_with_renew
      expect(@class.services_to_stop).to eq debian_services_to_stop
    end

    it 'should kill correct processes' do
      @class.expects(:run).with 'kill -9 100 101 102 103 104 105 106 107 108 109'
      @class.process_tree_with_renew
      @class.kill_pids_by_stop_regexp
    end
  ...
  context 'On RedHat system' do
    ...
    it 'should find services to stop' do
      @class.services_to_stop_with_renew
      expect(@class.services_to_stop).to eq redhat_services_to_stop
    end
